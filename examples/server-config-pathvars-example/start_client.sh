...
echo "Request: GET /users/e3055de7-49b0-4fbb-be69-ada06718cd53"
curl -f -s -X GET "$BASE_URL/users/e3055de7-49b0-4fbb-be69-ada06718cd53" \
...
curl -f -s -X GET "$BASE_URL/users/456/posts/789" \
...
curl -f -s -X POST "$BASE_URL/api/v1/organizations/org123/projects/proj456/tasks" \
...
echo "Request: PUT /users/e3055de7-49b0-4fbb-be69-ada06718cd53/profile"
curl -f -s -X PUT "$BASE_URL/users/e3055de7-49b0-4fbb-be69-ada06718cd53/profile" \
     -H "Content-Type: application/json" \
...
echo "Request: DELETE /users/e3055de7-49b0-4fbb-be69-ada06718cd53/comments/202"
curl -f -s -X DELETE "$BASE_URL/users/e3055de7-49b0-4fbb-be69-ada06718cd53/comments/202" \
...
curl -f -s -X GET "$BASE_URL/api/v2/products/electronics/laptop-x1/reviews" \
