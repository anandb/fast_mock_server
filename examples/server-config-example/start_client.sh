...
echo "======================================"
echo "Testing API Server (port 9001)"
echo "======================================"
echo ""
...
curl -f -X GET "$API_BASE_URL/api/users" -w "\nStatus Code: %{http_code}\n" -s
echo ""
echo "--------------------------------------"
echo ""
...
curl -f -X GET "$API_BASE_URL/api/users/1" -w "\nStatus Code: %{http_code}\n" -s
echo ""
echo "--------------------------------------"
echo ""
...
curl -f -X POST "$API_BASE_URL/api/users" \
